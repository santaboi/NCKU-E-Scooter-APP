...
btn.onclick = function () {
    ...
    setTimeout(function jump_butt() {
        jump_button = document.getElementById("back_button");
        jump_button.style.display = "block";
        jump_button.style.opacity = "0";

        setTimeout(function () { jump_button.style.opacity = "1"; }, 1500);
    }, "2500")
